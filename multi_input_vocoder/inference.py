...
def init_worker(queue, arguments):
    ...
    if os.path.isdir(a.checkpoint_file):
        config_file = r"D:\LipReading\Lip2SpeechUnit\lip2speech-unit\multi_input_vocoder\configs\lrs3\multi_input.json"
    else:
        config_file = r"D:\LipReading\Lip2SpeechUnit\lip2speech-unit\multi_input_vocoder\configs\lrs3\multi_input.json"
...
def main():
    ...
    if os.path.isdir(a.checkpoint_file):
        config_file = r"configs/lrs3/multi_input.json"
    else:
        config_file = r"configs/lrs3/multi_input.json"
    with open(config_file) as f:
        data = f.read()
