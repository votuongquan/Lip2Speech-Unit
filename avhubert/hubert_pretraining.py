...
class LabelEncoderS2SToken(object):
    ...
    def decode(self, tok, symbols_ignore=None):
        tok = self.dictionary.string(
            tok, extra_symbols_to_ignore=symbols_ignore)
...
class AVHubertPretrainingConfig(FairseqDataclass):
    ...
    image_aug: bool = field(default=False, metadata={
    ...
    modalities: Optional[List[str]] = field(default_factory=lambda: [
                                            "audio", "video"], metadata={'help': 'modalities to load'})
    is_s2s: bool = field(default=False, metadata={
...
class AVHubertPretrainingTask(FairseqTask):
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        if not self.cfg.is_s2s:
            ...
            procs = [LabelEncoderS2SToken(dictionary, bpe_tokenizer)
