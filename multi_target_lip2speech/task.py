...
class Lip2SpeechTask(AVHubertPretrainingTask):
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.cfg.data = 'D:/LipReading/Lip2SpeechUnit/lip2speech-unit/datasets/lrs3/label'
        self.cfg.label_dir = 'D:/LipReading/Lip2SpeechUnit/lip2speech-unit/datasets/lrs3/label'
        ...
        if not self.cfg.is_s2s:
            procs = [LabelEncoderUnit(dictionary)
